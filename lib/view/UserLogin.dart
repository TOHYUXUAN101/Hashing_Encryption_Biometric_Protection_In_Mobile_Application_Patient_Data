...
import 'package:hospitize/utils/service/DeviceID/DeviceID.dart';
                    ...
                    if(FormValidator.validatePasswordComplexity(context: context, uPass: userPassController.text)){
                      ...
                      if(retrieveData == null){
                        ScreenUtils.showCupertinoAlertDialog(
                          ...
                          final DeviceIdHelper DeviceId = DeviceIdHelper();
                          String deviceID = await DeviceId.getDeviceId();
                          debugPrint("here is device id generated during login: $deviceID");
                          
                          isLogin = FireStore.signIn(context: context, userEmail: userMailController.text, userNewlyHashed: hashValue, userPreviouslyHashed: retrieveData.uPassHashed, userIsValidated: retrieveData.uIsValidated, deviceUniqueID: deviceID, deviceUniqueIDRegistered: retrieveData.uDeviceID);
